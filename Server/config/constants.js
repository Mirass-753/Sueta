...
const NPC_ATTACK_COOLDOWN = 0.1;
const NPC_ATTACK_COOLDOWN_AFTER_MOVE = 0.05;
const NPC_AGGRO_RANGE = 4;
const NPC_LOSE_RANGE = 6;
const NPC_MEMORY_DURATION = 3;
const NPC_ATTACK_RANGE = 1.5;
const NPC_ATTACK_RANGE_START = 1.5;
const NPC_ATTACK_STOP_RANGE = 1.5;
const NPC_ATTACK_WINDOW_SECONDS = 0.5;
const NPC_ATTACK_FACING_DOT = 0.5;
const NPC_ARROW_HITBOX_SIZE_X = 0.20286;
const NPC_ARROW_HITBOX_SIZE_Y = 0.007;
const NPC_ARROW_HITBOX_OFFSET_X = 0.44982;
const NPC_ARROW_HITBOX_OFFSET_Y = 0.0105;
const PLAYER_HITBOX_SIZE_X = 1.0;
const PLAYER_HITBOX_SIZE_Y = 0.6;
const PLAYER_HITBOX_OFFSET_X = 0.0;
const PLAYER_HITBOX_OFFSET_Y = -0.02;
...
const PLAYER_ATTACK_WINDOW_SECONDS = 0.12;
const PLAYER_ATTACK_FACING_DOT = 0.5;

const HIT_PART_MULTIPLIERS = {
  Head: 2,
  Body: 1,
  Legs: 0.5,
  Face: 1.5,
...
const SNIFF_MAX_LEVEL = 9;
const SNIFF_EXP_PER_USE = 0.5;
const SNIFF_EXP_PER_LEVEL = 0.5;
const SNIFF_COOLDOWN_SECONDS = 6;
const SNIFF_SCREEN_CELLS_X = 14;
const SNIFF_SCREEN_CELLS_Y = 8;
const SNIFF_SPAWN_SCREENS_AWAY = 2;
const PREY_DROP_ITEM_NAME = 'Meat';
...
module.exports = {
  ...
  NPC_MEMORY_DURATION,
  NPC_ATTACK_RANGE,
  NPC_ATTACK_RANGE_START,
  NPC_ATTACK_STOP_RANGE,
  ...
  PLAYER_ATTACK_RANGE,
  PLAYER_ATTACK_WINDOW_SECONDS,
  PLAYER_ATTACK_FACING_DOT,
  HIT_PART_MULTIPLIERS,
  ENERGY_SEGMENTS,
  ...
  SNIFF_EXP_PER_USE,
  SNIFF_EXP_PER_LEVEL,
  SNIFF_COOLDOWN_SECONDS,
  SNIFF_SCREEN_CELLS_X,
  SNIFF_SCREEN_CELLS_Y,
  SNIFF_SPAWN_SCREENS_AWAY,
  PREY_DROP_ITEM_NAME,
};
